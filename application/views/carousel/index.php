    ...
    <div class="p-5 mt-5">
        ...
        <div class="card">
            <div class="card-header bg-primary d-flex justify-content-between">
                <h4 class="mt-2 text-white">carousel</h4>
                    ...
                    <tbody>
                        <?php foreach ($carousel as $c): ?>
                                            <tr>
                                                ...
                                                <td class="">
                                                    <a href="<?= base_url('assets/images/carousel/' . $c['foto']) ?>" class="" target="blank">
                                                        See Photo
                                                    </a>
                                                ...
                                                <td>
                                                    <div class="flex justify-content-center items-center text-center">
                                                        ...
                                                        <a class="btn btn-light-danger text-danger btn-lg px-4 fs-4 font-medium"
                                                            href="<?= base_url('carousel/deletePhoto/' . $c['foto']) ?>">
                                                            Delete
                                                        </a>
                                                    </div>
                                                </td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="card-body p-4">
                                        <form action="<?= base_url('carousel/editPhoto') ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-4">
                                                <img id="imagePreview" src="<?= base_url('assets/images/carousel/' . $g['foto']) ?>"
...
<div class="modal fade" id="addPhoto" tabindex="-1" aria-labelledby="vertical-center-modal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card-body p-4">
                    <form action="<?= base_url('carousel/addPhoto') ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-4">
                            <label for="exampleInputPassword1" class="form-label fw-semibold">Title</label>
