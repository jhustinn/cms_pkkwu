    ...
    <div class="container">
        <div class="border-bottom border-dark py-7">
            ...
            <div class="row align-items-center gx-xl-7">
                <div class="col-lg-6 text-center"><a href="#"><img class="img-fluid" src="<?= base_url('assets/images/konten/') . $konten[0]['foto'] ?>"
                            alt=""></a></div>
            ...
            <?php foreach ($konten as $k):
                $tanggal = new DateTime($k['tanggal']); ?>
                                                                                        <div class="col-lg-4 col-md-6 mb-5 mb-md-0 text-center text-md-start h-auto">
                                                                                            <div class="d-flex justify-content-between flex-column h-100"><a href="blog/<?= $k['slug'] ?>"><img
                                                                                                        class="w-md-100 w-75 rounded-2" src="<?= base_url('assets/images/konten/') . $k['foto'] ?>" alt=""></a>
