        ...
        <div class="container">
            <div class="row align-items-center py-lg-8 py-6">
                <div class="col-lg-6 text-center text-lg-start">
                    <h1 class="text-white fs-5 fs-xl-6">Cepat, Hemat, dan Aman!</h1>
                    <p class="text-white py-lg-3 py-2">Jika ingin membuat, dan membangun website terpercaya silahkan
                        hubungi email dan WhatsApp di bawah ini. di Akun resmi kami!</p>
                    <div class="d-sm-flex align-items-center gap-3"><a
                            href="https://wa.me/+6281548543722?text=Halo, saya mau membuat website." target="_blank"
                            ...
                            href="https://mail.google.com/mail/u/0/?view=cm&tf=1&fs=1&to=rexidesign.co@gmail.com"
                            target="_blank" class="btn btn-outline-light mb-3 w-75"><svg
                                style="margin-right: 4px;margin-bottom: 3px;" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="swiper">
                <div class="swiper-container swiper-shadow swiper-theme swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events swiper-container-free-mode"
                    ...
                    style="cursor: grab;">
                    <div class="swiper-wrapper" id="swiper-wrapper-76100f9e173e16111" aria-live="off"
                        style="transform: translate3d(-1827px, 0px, 0px); transition-duration: 0ms;">
                        <div class="swiper-slide text-center swiper-slide-duplicate" data-swiper-slide-index="0"
                            role="group" aria-label="1 / 6" style="width: 153px; margin-right: 50px;"><img
                                src="<?= base_url('assets/') ?>img/logos/codeigniter.png" width="50px" height="45px"
                                alt=""></div>
                        <div class="swiper-slide text-center swiper-slide-duplicate" data-swiper-slide-index="1"
                            role="group" aria-label="2 / 6" style="width: 153px; margin-right: 50px;"><img
                                src="<?= base_url('assets/') ?>img/logos/boldo.png" alt=""></div>
                        <div class="swiper-slide text-center swiper-slide-duplicate swiper-slide-duplicate-prev"
                            ...
                            style="width: 153px; margin-right: 50px;"><img
                                src="<?= base_url('assets/') ?>img/logos/laravel.png" width="50px" height="45px" alt="">
                        </div>
                        <div class="swiper-slide text-center swiper-slide-duplicate swiper-slide-duplicate-active"
                            ...
                            style="width: 153px; margin-right: 50px;"><img
                                src="<?= base_url('assets/') ?>img/logos/laravel.png" alt=""></div>
                        ...
                        <div class="swiper-slide text-center swiper-slide-duplicate" data-swiper-slide-index="5"
                            role="group" aria-label="6 / 6" style="width: 153px; margin-right: 50px;"><img
                                src="<?= base_url('assets/') ?>img/logos/boldo.png" alt=""></div>
                        <div class="swiper-slide text-center" data-swiper-slide-index="0" role="group"
                            aria-label="1 / 6" style="width: 153px; margin-right: 50px;"><img
                                src="<?= base_url('assets/') ?>img/logos/laravel.png" height="45px" alt=""></div>
                        <div class="swiper-slide text-center" data-swiper-slide-index="1" role="group"
                            aria-label="2 / 6" style="width: 153px; margin-right: 50px;"><img
                                src="<?= base_url('assets/') ?>img/logos/boldo.png" alt=""></div>
                        <div class="swiper-slide text-center swiper-slide-prev" data-swiper-slide-index="2" role="group"
                            aria-label="3 / 6" style="width: 153px; margin-right: 50px;"><img
                                src="<?= base_url('assets/') ?>img/logos/codeigniter.png" width="50px" height="45px"
                                alt=""></div>
                        <div class="swiper-slide text-center swiper-slide-active" data-swiper-slide-index="3"
                            role="group" aria-label="4 / 6" style="width: 153px; margin-right: 50px;"><img
                                src="<?= base_url('assets/') ?>img/logos/boldo.png" alt=""></div>
                        <div class="swiper-slide text-center swiper-slide-next" data-swiper-slide-index="4" role="group"
                            aria-label="5 / 6" style="width: 153px; margin-right: 50px;"><img
                                src="<?= base_url('assets/') ?>img/logos/laravel.png" height="45px" alt=""></div>
                        <div class="swiper-slide text-center" data-swiper-slide-index="5" role="group"
                            aria-label="6 / 6" style="width: 153px; margin-right: 50px;"><img
                                src="<?= base_url('assets/') ?>img/logos/boldo.png" alt=""></div>
                        <div class="swiper-slide text-center swiper-slide-duplicate" data-swiper-slide-index="0"
                            role="group" aria-label="1 / 6" style="width: 153px; margin-right: 50px;"><img
                                src="<?= base_url('assets/') ?>img/logos/codeigniter.png" width="50px" height="45px"
            ...
            <div class="carousel-inner rounded-2">
                ...
                foreach ($carousel as $c): ?>
                                            <div class="carousel-item <?php if ($no == 1) {
                                                ...
                                                <img src="<?= base_url('assets/images/carousel/') . $c['foto'] ?>" class="rounded-2 w-100" alt="">
...
<section>
    <div class="container">
        ...
        <h2 class="mx-auto text-center fs-lg-6 fs-md-5 w-lg-75">Admin Social Media yang selalu memantau.</h2>
    </div><!-- end of .container-->
</section>
...
<section>
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 text-center text-lg-start"><img class="img-fluid" src="assets/40831.jpg" alt="">
            </div>
            <div class="col-lg-6">
                <h1 class="fs-xl-5 fs-lg-4 fs-3">Kami menyediakan pelayanan yang maksimal bagi pelanggan mami, di social media maupun website.</h1>
                <ul class="list-unstyled my-xl-5 my-3">
                    <li class="fs-2 my-4 d-flex align-items-center gap-3 text-black"><svg
                            class="svg-inline--fa fa-circle-check fs-4 text-dark" aria-hidden="true" focusable="false"
                        ...
                        <!-- <i class="fa-solid fa-circle-check fs-4 text-dark"></i> Font Awesome fontawesome.com --><span>Respon Cepat.</span></li>
                    <li class="fs-2 my-4 d-flex align-items-center gap-3 text-black"><svg
                            class="svg-inline--fa fa-circle-check fs-4 text-dark" aria-hidden="true" focusable="false"
                            data-prefix="fas" data-icon="circle-check" role="img" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512" data-fa-i2svg="">
                        ...
                        <!-- <i class="fa-solid fa-circle-check fs-4 text-dark"></i> Font Awesome fontawesome.com --><span>Pelayanan Terjamin.</span></li>
                    <li class="fs-2 my-4 d-flex align-items-center gap-3 text-black"><svg
                            class="svg-inline--fa fa-circle-check fs-4 text-dark" aria-hidden="true" focusable="false"
                            data-prefix="fas" data-icon="circle-check" role="img" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512" data-fa-i2svg="">
                        ...
                        <!-- <i class="fa-solid fa-circle-check fs-4 text-dark"></i> Font Awesome fontawesome.com --><span>Membangun Kepercayaan Dengan Pelanggan.</span></li>
        ...
        <div class="d-flex flex-column-reverse flex-lg-row">
            <div class="col-lg-6">
                ...
                <ul class="list-unstyled">
                    <li class="fs-2 shadow-sm offer-list-item"><svg class="svg-inline--fa fa-leaf fs-lg-4 fs-3"
                            aria-hidden="true" focusable="false" data-prefix="fas" data-icon="leaf" role="img"
                        ...
                        <!-- <i class="fa-solid fa-leaf fs-lg-4 fs-3"></i> Font Awesome fontawesome.com --><span>We
                            connect our customers with the best.</span></li>
                    <li class="fs-2 shadow-sm offer-list-item"><svg class="svg-inline--fa fa-eye fs-lg-4 fs-3"
                        ...
                        <!-- <i class="fa-solid fa-eye fs-lg-4 fs-3"></i> Font Awesome fontawesome.com --><span>Advisor
                            success customer launch party.</span></li>
                    <li class="fs-2 shadow-sm offer-list-item"><svg class="svg-inline--fa fa-sun fs-lg-4 fs-3"
                            aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sun" role="img"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                            <path fill="3918929lor"
                        ...
                        <!-- <i class="fa-solid fa-sun fs-lg-4 fs-3"></i> Font Awesome fontawesome.com --><span>Business-to-consumer
                            long tail.</span></li>
                </ul>
            </div>
            <div class="col-lg-6 text-center text-lg-end"><img class="img-fluid" src="assets/3918929.jpg" alt="">
            </div>
        </div>
    </div><!-- end of .container-->
</section>
