            ...
            <div class="carousel-inner rounded-2">
                ...
                foreach ($carousel as $c): ?>
                                            <div class="carousel-item <?php if ($no == 1) {
                                                ...
                                                <img src="<?= base_url('assets/images/carousel/') . $c['foto'] ?>" class="rounded-2 w-100"
                                                    alt="">
        ...
        <div class="row gx-xl-7 mt-5">
            <div class="col-md-4 mb-6 mb-md-0 text-center text-md-start"><img class="w-50 w-md-100"
                ...
                <p class="fs-1 mb-0">Learning curve network effects return on investment.</p><a
                    class="text-dark fs-1 pb-2 fw-bold border-black border-bottom text-decoration-none" href="#">Explore
                    page<svg class="svg-inline--fa fa-arrow-right ms-2" aria-hidden="true" focusable="false"
                    ...
                    </svg><!-- <i class="fa-solid fa-arrow-right ms-2"></i> Font Awesome fontawesome.com --></a>
            </div>
            <div class="col-md-4 mb-6 mb-md-0 text-center text-md-start"><img class="w-50 w-md-100"
...
<section>
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 text-center text-lg-start"><img class="img-fluid" src="assets/img/offer/1.png" alt="">
            </div>
            <div class="col-lg-6">
                ...
                <ul class="list-unstyled my-xl-5 my-3">
                    <li class="fs-2 my-4 d-flex align-items-center gap-3 text-black"><svg
                        ...
                        <!-- <i class="fa-solid fa-circle-check fs-4 text-dark"></i> Font Awesome fontawesome.com --><span>We
                    ...
                    <li class="fs-2 my-4 d-flex align-items-center gap-3 text-black"><svg
                        ...
                        <!-- <i class="fa-solid fa-circle-check fs-4 text-dark"></i> Font Awesome fontawesome.com --><span>Advisor
                    ...
                    <li class="fs-2 my-4 d-flex align-items-center gap-3 text-black"><svg
                        ...
                        <!-- <i class="fa-solid fa-circle-check fs-4 text-dark"></i> Font Awesome fontawesome.com --><span>Business-to-consumer
                            long tail.</span></li>
...
<section class="pt-8 pt-lg-0">
    <div class="container">
        <div class="d-flex flex-column-reverse flex-lg-row">
            ...
            <div class="col-lg-6 text-center text-lg-end"><img class="img-fluid" src="assets/img/offer/2.png" alt="">
            </div>
        </div>
    </div><!-- end of .container-->
</section>
