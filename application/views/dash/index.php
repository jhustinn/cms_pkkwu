...
<div class="container px-4 md:px-0 max-w-6xl mx-auto -mt-32">
    ...
    <div class="mx-0 sm:mx-6">
        ...
        <!--Nav-->
        <nav class="mt-0 w-full bg-slate-800 rounded overflow-hidden shadow-lg">
        ...
        <div class="bg-gray-200 w-full bg-fixed text-xl md:text-2xl text-gray-800 leading-normal rounded-t">

            <div class="js-show-on-scroll my-5 h-full bg-white rounded overflow-hidden">
                <div class="carousel w-full">
                    <div id="item1" class="carousel-item w-full">
                        <img src="https://source.unsplash.com/collection/494263/1200x200" class="" />
                    </div>
            ...
            <div class="js-show-on-scroll flex justify-center w-full py-2 gap-2">
            ...
            <!--Lead Card-->
            <div class="js-show-on-scroll flex h-full bg-white rounded overflow-hidden shadow-lg">
            ...
            <div class="flex flex-wrap justify-between pt-12 -mx-6">
                ...
                <!--1/3 col -->
                <div class="js-show-on-scroll w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                ...
                <div class="js-show-on-scroll mockup-phone">
                ...
                <!--1/2 col -->
                <div class="js-show-on-scroll w-full md:w-1/2 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                        <a href="#" class="flex flex-wrap no-underline hover:no-underline">
                ...
                <!--2/3 col -->
                <div class="js-show-on-scroll w-full md:w-2/3 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                        <a href="#" class="flex flex-wrap no-underline hover:no-underline">
        ...
        <!--Subscribe-->
        <div class="js-show-on-scroll container font-sans bg-green-100 rounded mt-8 p-4 md:p-24 text-center">
        ...
        <!--Author-->
        <div class="js-show-on-scroll flex w-full items-center font-sans p-8 md:p-24">
